...
Setup (GPU cluster - for GPU examples):
    ...
    gcloud container node-pools create gpu-pool \\
        ...
        --accelerator type=gpu-nvidia-tesla-t4,count=1 \\
        --num-nodes 1 \\
...
Supported accelerators:
    ...
    - gpu-nvidia-tesla-t4, gpu-t4: NVIDIA T4
    - gpu-nvidia-l4, gpu-l4: NVIDIA L4
    - gpu-nvidia-tesla-v100, gpu-v100: NVIDIA V100
    - gpu-nvidia-tesla-a100, gpu-a100: NVIDIA A100 (40GB)
    - gpu-a100-80gb: NVIDIA A100 (80GB)
    - gpu-nvidia-h100-80gb, gpu-h100: NVIDIA H100
"""
...
@kinetic.run(accelerator="gpu-nvidia-tesla-t4")
def train_model_gpu():
